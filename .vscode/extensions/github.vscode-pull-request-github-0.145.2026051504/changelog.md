...
![Use paste to upload an image](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.144.0/upload-an-image.gif)
...
* [@MaxDNG](https://github.com/MaxDNG): Re-parent pulled-up directory children to ensure proper checkbox refresh [PR [#8679](https://github.com/Microsoft/vscode-pull-request-github/issues/8679)](https://github.com/microsoft/vscode-pull-request-github/pull/8679)
...
* [@mohamedamara1](https://github.com/mohamedamara1): Display linked issue(s) from the PR Overview [PR [#6835](https://github.com/Microsoft/vscode-pull-request-github/issues/6835)](https://github.com/microsoft/vscode-pull-request-github/pull/6835)
...
* [@Will-hxw](https://github.com/Will-hxw): Use `pr.base.ref` instead of `pr.base.name` in `hasBranch` call [PR [#8698](https://github.com/Microsoft/vscode-pull-request-github/issues/8698)](https://github.com/microsoft/vscode-pull-request-github/pull/8698)
...
* [@Daniel-Aaron-Bloom](https://github.com/Daniel-Aaron-Bloom): Link to local file for permalinks in webview [PR [#8583](https://github.com/Microsoft/vscode-pull-request-github/issues/8583)](https://github.com/microsoft/vscode-pull-request-github/pull/8583)
...
* [@gvilums (Georgijs)](https://github.com/gvilums): Fix PR tree reveal errors for flat file layout [PR [#8522](https://github.com/Microsoft/vscode-pull-request-github/issues/8522)](https://github.com/microsoft/vscode-pull-request-github/pull/8522)
...
![Button to change pull request template](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.126.0/change-pr-template.png)
...
![Convert to draft](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.126.0/convert-to-draft.png)
...
![Generate description for an existing pull request](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.126.0/generate-existing-description.png)
...
![Change base branch](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.126.0/change-base-branch.png)
